package com.example.darkknight.tenorplay.databases
...
class TenorPlayDatabase: SQLiteOpenHelper {
    ...
    override fun onCreate(sqliteDatabase: SQLiteDatabase?) {
        sqliteDatabase?.execSQL("CREATE TABLE " + Staticated.TABLE_NAME +
                " ( " + Staticated.COLUMN_ID + " INTEGER, " + Staticated.COLUMN_SONG_ARTIST + " STRING, "
